...
public class SmallSnowPile : MonoBehaviour
{

    public GameObject[] smallSnowModels;
    ...
    {
        Instantiate(smallSnowModels[Random.Range(0, smallSnowModels.Length)], atPosition, Quaternion.Euler(0.0f, Random.Range(0.0f, 360.0f), 0.0f) );
    }
